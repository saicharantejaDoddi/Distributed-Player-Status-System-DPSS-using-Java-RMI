...
public class NorthAmericanGameServer extends UnicastRemoteObject
		implements IPlayerClient, IAdministratorClient, Runnable {
	logManager NorthAmericanGameServerLogManager = null;
	static final String NORTHAMERICAN = "NorthAmericanGameServer_LogReport";

	protected NorthAmericanGameServer() throws RemoteException {
		super();
		NorthAmericanGameServerLogManager = new logManager(NORTHAMERICAN);
		NorthAmericanGameServerLogManager.insertMessage("NorthAmerican Server is started !!!!!!!!!!!!" + "\r\n");
	...
	public static void startServer() throws Exception {
		...
		Naming.rebind("rmi://localhost:3001" + "/NorthAmericanServer", obj);
	...
	public String getPlayerStatus(String userName, String password, String ipAddress) throws RemoteException {
		...
		synchronized(this)
		{
			String message3 = Client(9003, "Asian Game Server");
